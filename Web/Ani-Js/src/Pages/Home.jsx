    ...
    >
      ...
      <div className="relative z-10">
        ...
        <div className="w-full min-h-screen flex items-center justify-center text-center px-6 py-24">
          <div className="max-w-4xl mx-auto bg-black/70 backdrop-blur-sm p-10 rounded-xl ">
        ...
        <div id="what" className="py-16 px-6 text-center">
          <div className=" ani-scroll max-w-4xl mx-auto bg-black/70 backdrop-blur-sm p-8 rounded-xl">
        ...
        <div className="py-16 px-6">
          <div className="max-w-6xl mx-auto">
            <div className="bg-black/70 backdrop-blur-sm p-8 rounded-xl ani-scroll">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="bg-blue-900/50 p-6 rounded-xl border border-blue-800 tw-hoverenlarge">
                  <h3 className="text-xl font-semibold mb-3 flex items-center text-blue-300">
                    <span className="mr-2">💡</span> Easy-to-use API
                  </h3>
                ...
                <div className="bg-blue-900/50 p-6 rounded-xl border border-blue-800 tw-hoverenlarge">
                  <h3 className="text-xl font-semibold mb-3 flex items-center text-blue-300">
                    <span className="mr-2">🧩</span> Works with Vanilla JS & React
                  </h3>
                  <p>Supports usage in plain HTML/JS as well as in React apps.</p>
                </div>
                <div className="bg-blue-900/50 p-6 rounded-xl border border-blue-800 tw-hoverenlarge">
                  <h3 className="text-xl font-semibold mb-3 flex items-center text-blue-300">
                    <span className="mr-2">⚙️</span> Zero Dependencies
                  </h3>
        ...
        <div className="py-16 px-6 ani-scroll">
          <div className="max-w-6xl mx-auto">
            <div className="bg-black/70 backdrop-blur-sm p-8 rounded-xl">
              <h2 className="text-3xl font-bold text-center mb-12 text-blue-400">🔍 Why Choose Ani-Js?</h2>
        ...
        {/* FAQ Section */}
        <div className="py-16 px-6 ani-scroll">
          <div className="max-w-4xl mx-auto bg-black/70 backdrop-blur-sm p-8 rounded-xl">
        ...
        <div className="py-16 px-6 ani-scroll">
          <div className="max-w-4xl mx-auto bg-black/70 backdrop-blur-sm p-8 rounded-xl text-center">
            <h2 className="text-3xl font-bold mb-6 text-blue-400">🏗️ Built with ani-js</h2>
        ...
        <div className="py-16 px-6 text-center ani-scroll">
          <h2 className="text-3xl font-bold mb-6 text-blue-400">🌐 Community & Support</h2>
